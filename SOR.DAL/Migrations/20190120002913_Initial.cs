    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TableId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FoodId = table.Column<Guid>(nullable: false, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SORUserId = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservations", x => new { x.SORUserId, x.TableId });
                    table.ForeignKey(
                        name: "FK_Reservations_AspNetUsers_SORUserId",
                        column: x => x.SORUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
